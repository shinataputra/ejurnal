                ...
                <div class="flex-1 flex flex-col overflow-hidden">
                    ...
                    <header class="bg-white shadow-sm md:hidden sticky top-0 z-30">
                        <div class="flex items-center justify-between p-3">
                            <!-- Left: Menu Button -->
                            <button id="menuToggle" onclick="toggleSidebar()" class="p-2 rounded-lg hover:bg-gray-100 transition flex-shrink-0">
                            ...
                            <div class="relative flex-shrink-0">
                                ...
                                <!-- Dropdown Menu -->
                                <div id="adminProfileDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg z-50 border border-gray-200">
                                    <div class="p-4 border-b border-gray-200">
                                        <p class="text-sm font-semibold text-gray-900 truncate"><?= htmlspecialchars($current_user['name']) ?></p>
