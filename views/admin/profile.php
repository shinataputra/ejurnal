...
<div class="max-w-3xl mx-auto space-y-4">
    <div class="bg-white rounded-lg shadow p-4 md:p-6">
        <h2 class="text-lg font-bold mb-3">Profil Akun (Admin)</h2>
        ...
        <form method="post" action="index.php?p=admin/profile" class="space-y-3">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="?p=admin/dashboard" class="text-sm text-gray-600 hover:underline">Kembali</a>
            </div>
        </form>
    </div>
